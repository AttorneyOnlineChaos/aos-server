...
Q_LOGGING_CATEGORY(kenji::log::protocol, "kenji.protocol")
Q_LOGGING_CATEGORY(kenji::log::discord, "kenji.discord")
Q_LOGGING_CATEGORY(kenji::log::acl, "kenji.acl")
Q_LOGGING_CATEGORY(kenji::log::evidence, "kenji.evidence")
