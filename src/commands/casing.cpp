...
void kenji::AOClient::cmdDoc(int argc, QStringList argv)
{
...
void kenji::AOClient::cmdClearDoc(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdEvidenceMod(int argc, QStringList argv)
{
  Q_UNUSED(argc);
...
void kenji::AOClient::cmdEvidence_Swap(int argc, QStringList argv)
{
  Q_UNUSED(argc);
...
void kenji::AOClient::cmdTestify(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdExamine(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
  ...
  if (l_area->testimony().size() - 1 > 0)
  {
    ...
    else
    {
      ...
      l_splash.type = theory::SplashType::CrossExamination;
      server->broadcastToArea(l_splash, areaId());
      server->broadcastToArea(l_area->testimony()[0], areaId());
      return;
    }
  }
  else
...
void kenji::AOClient::cmdTestimony(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdDeleteStatement(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdUpdateStatement(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdPauseTestimony(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
  ...
  theory::SplashPacket l_splash;
  l_splash.type = theory::SplashType::None;
  server->broadcastToArea(l_splash, areaId());
  sendServerMessage("Testimony has been stopped. Use /examine to begin cross-examination.");
}

void kenji::AOClient::cmdAddStatement(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  Q_UNUSED(argv);
...
void kenji::AOClient::cmdSaveTestimony(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  ...
  if (l_permission_found)
  {
    ...
    if (l_file.open(QIODevice::WriteOnly | QIODevice::Append | QIODevice::Text))
    {
      ...
      {
        theory::IcMessagePacket l_statement = l_area->testimony().at(i);
        theory::JsonEncodeBinder l_writer;
...
void kenji::AOClient::cmdLoadTestimony(int argc, QStringList argv)
{
  Q_UNUSED(argc);
  ...
  while (!l_in.atEnd())
  {
    if (l_testimony_lines <= ConfigManager::maxStatements())
    {
      ...
      QJsonDocument l_document = QJsonDocument::fromJson(line.toUtf8());
      if (!l_document.isObject())
      {
        sendServerMessage("Unable to load testimony. The file is not a valid testimony.");
        clearTestimony();
        return;
      }
