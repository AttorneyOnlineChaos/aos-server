...
public:
  ...
  virtual void broadcastToPlayer(const theory::Packet &packet, theory::PlayerId playerId) = 0;
  ...
  virtual void broadcastMessageToPlayer(const QString &message, theory::PlayerId playerId, theory::ServerMessagePacket::Level level = theory::ServerMessagePacket::Message) = 0;
};
} // namespace kenji
